 ...
 */
@RestController
@RequestMapping("/manage/task_type")
public class TaskTypeController extends BaseController
{
     ...
     * 查询工单类型列表
     */
    @PreAuthorize("@ss.hasPermi('manage:task_type:list')")
    @GetMapping("/list")
     ...
     * 导出工单类型列表
     */
    @PreAuthorize("@ss.hasPermi('manage:task_type:export')")
     ...
     * 获取工单类型详细信息
     */
    @PreAuthorize("@ss.hasPermi('manage:task_type:query')")
     ...
     * 新增工单类型
     */
    @PreAuthorize("@ss.hasPermi('manage:task_type:add')")
     ...
     * 修改工单类型
     */
    @PreAuthorize("@ss.hasPermi('manage:task_type:edit')")
     ...
     * 删除工单类型
     */
    @PreAuthorize("@ss.hasPermi('manage:task_type:remove')")
