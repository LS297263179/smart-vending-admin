<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="skuList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="商品编号" align="center" prop="innerCode" /> -->
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="skuRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品价格" prop="price">
          <el-input-number v-model="form.price" :min="0.01" :max="1000000" :precision="2" placeholder="请输入商品价格" />元
...
<el-dialog title="数据导入" v-model="excelOpen" width="400px" append-to-body>
  <el-upload ref="uploadRef" class="upload-demo"
    ...
    <el-button class="ml-3" type="success" @click="submitUpload" style="margin: 10px;">
      上传
    </el-button>
    <template #tip>
      <div class="el-upload__tip">
