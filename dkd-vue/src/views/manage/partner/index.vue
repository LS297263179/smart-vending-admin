<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
      <el-form-item label="合作商搜索：" prop="partnerName">
        <el-input
...
>
  <el-row :gutter="20">
    <el-col :span="12">
      <el-card shadow="never" body-style="padding:16px;text-align:center">
        ...
        <div style="font-size:13px;color:#909399;margin:4px 0">合作商名称</div>
        <div style="font-size:15px;color:#303133;font-weight:500">{{ form.partnerName }}</div>
      </el-card>
    </el-col>
    <el-col :span="12">
      <el-card shadow="never" body-style="padding:16px;text-align:center">
        <el-icon style="font-size:20px;color:#409eff"><Avatar /></el-icon>
        <div style="font-size:13px;color:#909399;margin:4px 0">联系人</div>
        <div style="font-size:15px;color:#303133;font-weight:500">{{ form.contactPerson }}</div>
      </el-card>
    </el-col>
  </el-row>
  ...
  <el-row :gutter="20" style="margin-top:12px">
    <el-col :span="12">
      <el-card shadow="never" body-style="padding:16px;text-align:center">
        <el-icon style="font-size:20px;color:#409eff"><Phone /></el-icon>
        <div style="font-size:13px;color:#909399;margin:4px 0">联系电话</div>
        <div style="font-size:15px;color:#303133;font-weight:500">{{ form.contactPhone }}</div>
      </el-card>
    </el-col>
    <el-col :span="12">
      <el-card shadow="never" body-style="padding:16px;text-align:center">
        <el-icon style="font-size:20px;color:#409eff"><Coin /></el-icon>
        <div style="font-size:13px;color:#909399;margin:4px 0">分成比例</div>
        <div style="font-size:15px;color:#303133;font-weight:500">{{ form.profitRatio }}%</div>
      </el-card>
    </el-col>
  </el-row>

  <!-- <template #footer>
    <el-button type="primary" @click="partnerInfoOpen = false">关 闭</el-button>
  </template> -->
</el-dialog>
...
function resetPwd(row) {
  const _id = row.id
  proxy.$modal.confirm('是否确认重置该合作商的密码吗？').then(function() {
